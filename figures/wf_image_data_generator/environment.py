...
class FireEnvironment(gym.Env):
    ...
    def reward(self, uav):
        ...
        uav.obs.image.coverage_map[x_view_min:x_view_max, y_view_min:y_view_max] = np.full(((x_view_max-x_view_min), (y_view_max-y_view_min)), 255)
