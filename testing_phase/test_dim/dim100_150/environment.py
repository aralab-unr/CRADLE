...
class FireEnvironment(gym.Env):
    ...
    def __init__ (self, x_len, y_len):
        ...
        self.x_len = x_len
        self.y_len = y_len
        self.fire_x = self.x_len // 2
        self.fire_y = self.y_len // 2
        self.fire_x_start = self.fire_x - 2
        self.fire_y_start = self.fire_y - 2
        self.fire_x_end = self.fire_x + 2
        self.fire_y_end = self.fire_y + 2
        self.flame_min = 15
        self.flame_max = 20
